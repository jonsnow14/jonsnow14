...
Five years building applied ML and LLM systems across manufacturing, supply chain, healthcare, and education. I ship RAG and agent products — hybrid retrieval, fail-closed ACLs, citation grounding, eval harnesses . Production computer-vision, NLP  and time-series models I built are used by **Mahindra**, **Flexera**, and **Dorman**.
